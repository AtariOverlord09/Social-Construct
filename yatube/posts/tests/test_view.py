...
class PostsContextTest(TestCase):
    ...
    def test_context_for_group_list_page(self):
        """
        Тест контекста group_list
        """
    ...
    def test_for_post_edit_page(self):
        ...
        self.assertEqual(response.group.slug, self.group.slug)
...
class PostsGroupTest(TestCase):
    ...
    def test_post_appears_on_index_group_list_profile(self):
        posts_pages = {
